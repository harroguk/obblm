                ...
                <div class='boxBody'>
                    <table class="boxTable">
                        ...
                        foreach ($players as $p) {
							if (!$p['date_sold'] > 0 AND $p['status'] <> 8) {
								echo "<tr>\n";
...
function _events($event, $node, $node_id, $N) {
    ...
    switch ($event) {
        ...
        case 'sold':
        case 'hired':
            $dispColumns = array('tname' => $lng->getTrn('common/team'), 'name' => $lng->getTrn('common/player'), 'f_pos_name' => $lng->getTrn('common/pos'), 'value' => $lng->getTrn('common/value'));            break;

        case 'skills':
            $dispColumns = array('tname' => $lng->getTrn('common/team'), 'name' => $lng->getTrn('common/player'), 'f_pos_name' => $lng->getTrn('common/pos'), 'skill' => $lng->getTrn('common/skill'), 'value' => $lng->getTrn('common/value'));
            break;
