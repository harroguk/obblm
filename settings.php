...
$settings['site_name'] = 'TGV League'; 			// Site name.
$settings['default_visitor_league'] = 3;           // ID of default league to show on front page when not logged in/coach has not selected a home league.
$settings['default_leagues']        = array(3,6,7);    // When creating a coach the coach will automatically become a regular coach in leauges with these IDs.
...
// Rule #4 - Exhibition League
// $hrs[4]['rule']   = array('-pts', '-played', '-tdcas');    // Sort teams against: most points, then most TDs and then least sportsmanship points.
// $hrs[4]['points'] = '[won]/[played] + 0.5*[draw]/[played] + [played]/100'; // The definition of points.

// Rule #5 - TGV League
$hrs[5]['rule']   = array('-pts', '+played', '-tdcas');    // Sort teams against: most points, then most TDs and then least sportsmanship points.
$hrs[5]['points'] = '2*[won] + 1*[draw]'; // The definition of points.

// Rule #6 - Exhibition League (Trial)
$hrs[6]['rule']   = array('-pts', '-elo', '-played', '-tdcas');    // Sort teams against: most points, then most TDs and then least sportsmanship points.
$hrs[6]['points'] = '1*[elo]'; // The definition of points.
