...
$settings['league_name'] = 'Exhibition League'; // Name of the site or the league name if only one league is being managed.
...
$settings['welcome']     = 'Welcome to The Games Vault Blood Bowl League.<br><br>Contact Harroguk on The Games Vault Forum and he will create you an account and give you your login details.<br><br>Login to this page then use your Coaches Corner (CC) to create your starting team.<br><br>Once you will be automatically entered into the next League that starts.';
$settings['rules']       = '<a href=http://www.tybbl.org.uk/library/turfrulebook.pdf>Yorkshire Blood Bowl Turf Rulebook</a>';
...
$settings['fp_standings'] = array(
    ...
    array(
        ...
        'type'   => 'tournament',
        'HRS'    => 5,		
        'title'  => 'Exhibition League Standings',
        'length' => 15,
        # Format: "Displayed table column name" => "OBBLM field name".
                'fields' => array('Name' => 'name',  'P' => 'played', 'W' => 'won', 'D' => 'draw', 'L' => 'lost', 'ELO' => 'pts'),
    ),
...
$settings['fp_latestgames'] = array(
    ...
    array(
        ...
        'title'  => 'Recent games for Exhibition League',
        'length' => 8,
    ),
);
